...
def get_default_config():
    ...
    cfg.model.bpbreid.hrnet_pretrained_path = "REID/bpbreid/pretrained_models/" # path to pretrained weights for HRNet backbone, download on our Google Drive or on https://github.com/HRNet/HRNet-Image-Classification
    # number of horizontal stripes desired. When BPBreID is used, this variable will be automatically filled depending
    # on "data.masks.preprocess"  ##GIBRAN, changed path dir
    ...
    cfg.data = CN()
    cfg.data.type = 'image'
    cfg.data.root = 'REID/bpbreid/reid-data' #GIBRAN, changed path dir
    ...
    cfg.inference.input_folder = "C:\\Users\\gba2_\\Desktop\\repo\\extractData"
