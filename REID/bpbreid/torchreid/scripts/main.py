...
def main():
    ...
    #     print(cfg.inference.input_folder)
...
def build_config(args=None, config_file=None, config=None):
    ...
    #os.makedirs(cfg.data.save_dir)  ##GIBRAN, avoid creaiting logs, it tries to recreate the same log number for some reason, this breaks the program in each dataset iteration
    return cfg
